...
<table>
  <tr>
    <td align="center">
      ...
      <br><b>Figma</b>
      <hr>
      Ferramenta de design para criação dos protótipos e visualização do layout do projeto.
    </td>
    <td align="center">
      ...
      <br><b>Git</b>
      <hr>
      Sistema de controle de versão utilizado para gerenciar o histórico de alterações do projeto.
    </td>
    <td align="center">
      ...
      <br><b>GitHub</b>
      <hr>
      Plataforma utilizada para hospedar o repositório e facilitar a colaboração entre a equipe.
    </td>
    <td align="center">
      ...
      <br><b>VS Code</b>
      <hr>
      Editor de código utilizado para escrever e editar os arquivos HTML, CSS e JavaScript.
    </td>
  </tr>
</table>
...
<table>
  <tr>
    ...
    <td align="center">
      ...
      <br><b>CSS3</b>
      <hr>
      Linguagem de estilo utilizada para estilizar as páginas e tornar o layout responsivo.
    </td>
    <td align="center">
      ...
      <br><b>JavaScript</b>
      <hr>
      Linguagem de programação utilizada para tornar as páginas interativas e manipular o DOM.
    </td>
  </tr>
</table>
...
O design deste projeto foi desenvolvido no Figma, onde criamos nosso protótipo, que pode ser visualizado e explorado [aqui](https://www.figma.com/design/VjYtVPyibnVZxwYWkq8MWC/Includify?node-id=0-1).
...
👉 [Confira o board do projeto do GitHub clicando aqui](https://github.com/users/LeonardoReis86/projects/13/views/1)
...
1. **Clone o Repositório**:
   Primeiro, clone o repositório em seu computador. Abra o terminal e execute o seguinte comando:

   ```bash
   git clone https://github.com/LeonardoReis86/Includify.git
   ```
2. **Acesse o Diretório do Projeto**: Depois de clonar o repositório, navegue até o diretório do projeto:

   ```bash
   cd Includify
   ```
3. **Abra o Projeto no Navegador**: Como este projeto consiste apenas em HTML, CSS e JavaScript, não há necessidade de instalar dependências adicionais ou configurar um servidor. Basta abrir o arquivo `index.html` diretamente em seu navegador. Você pode fazer isso de duas formas:

   - **Manualmente**: Navegue até o diretório do projeto e dê um duplo clique no arquivo `index.html`.

   - **Via Linha de Comando**: Execute o comando abaixo (funciona em sistemas que suportam `open`, `xdg-open`, ou equivalente):
